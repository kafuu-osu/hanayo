// Package btcaddress makes sure the Bitcoin address for the kafuu-osu! donations
...
// The wallet with the name "kafuu-osu!" will be used for getting the address.
package btcaddress
